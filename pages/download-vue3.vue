<template lang='pug'>
  .banner
    .wrapper
      ...
      p.lead Your download will start momentarily. If you do not see it, please click #[a.bold(href='/pdf/Vue-3-Cheat-Sheet.pdf' download ref='download') restart download].
...
export default {
  ...
  head () {
    return {
      title: '[Downloading...] Vue 3 Cheat Sheet | Vue Mastery',
      meta: [{
        hid: 'og:url',
        property: 'og:url',
