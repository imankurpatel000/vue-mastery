    ...
    div(v-if='ready')
      ...
      .title
        transition-group(name="thankyou" @after-enter="showCard")
          ...
          p.copy(v-if='show' key="copy") Your gift has been purchased.
      ...
      transition(name="thankyou")
        .card(v-if="card")
          .card-body
            h4
              i.fa.fa-book &nbsp;
              | We have sent an you an email
            p It contains an invoice for your records, and the gift will be delivered as you've intended.

            h4
              i.far.fa-thumbs-up &nbsp;
              | Your Feedback
            p If you have any feedback for us or need some support, we’d love to hear from you. You can use the #[nuxt-link(to='/contact') contact] form or just email #[a(href='mailto:team@vuemastery.com' target='_blank') team@vuemastery.com].
</template>
